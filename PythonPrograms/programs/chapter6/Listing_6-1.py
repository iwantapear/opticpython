...
from scipy import pi, linspace, meshgrid, sin, arcsin, cos, tan, arctan2, sqrt, array
...
class MplCanvas(FC):
    ...
    def drawPlot(self, nOne, nTwo, rad, objDist, objHt):
        ...
        sfc = mpatches.Arc([rad1, 0], 2 * rad1, 2 * rad1,
                           angle=0, theta1=90, theta2=270, color='k')
